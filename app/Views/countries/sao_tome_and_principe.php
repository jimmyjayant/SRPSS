...
<?php
$cachefile = "../writable/cache/" . "sao_tome_and_principe_main_body.php" . ".cache";
...
fclose($fp);
//ob_end_flush();
$sao_tome_and_principe_main_body = ob_get_clean(); // clean or empty the buffer 
echo $sao_tome_and_principe_main_body;
}
?>
