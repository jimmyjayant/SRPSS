...
<?php
$cachefile = "../writable/cache/" . "central_african_republic_main_body.php" . ".cache";
...
fclose($fp);
//ob_end_flush();
$central_african_republic_main_body = ob_get_clean(); // clean or empty the buffer 
echo $central_african_republic_main_body;
}
?>
