...
<?php
$cachefile = "../writable/cache/" . "united_arab_emirates_main_body.php" . ".cache";
...
fclose($fp);
//ob_end_flush();
$united_arab_emirates_main_body = ob_get_clean(); // clean or empty the buffer 
echo $united_arab_emirates_main_body;
}
?>
