...
<?php
$cachefile = "../writable/cache/" . "papua_new_guinea_main_body.php" . ".cache";
...
fclose($fp);
//ob_end_flush();
$papua_new_guinea_main_body = ob_get_clean(); // clean or empty the buffer 
echo $papua_new_guinea_main_body;
}
?>
