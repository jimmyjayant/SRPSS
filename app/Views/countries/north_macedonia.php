...
<?php
$cachefile = "../writable/cache/" . "north_macedonia_main_body.php" . ".cache";
...
fclose($fp);
//ob_end_flush();
$north_macedonia_main_body = ob_get_clean(); // clean or empty the buffer 
echo $north_macedonia_main_body;
}
?>
