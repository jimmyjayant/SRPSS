...
<?php
$cachefile = "../writable/cache/" . "trinidad_and_tobago_main_body.php" . ".cache";
...
fclose($fp);
//ob_end_flush();
$trinidad_and_tobago_main_body = ob_get_clean(); // clean or empty the buffer 
echo $trinidad_and_tobago_main_body;
}
?>
