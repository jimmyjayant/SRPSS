...
<?php
$cachefile = "../writable/cache/" . "marshall_islands_main_body.php" . ".cache";
...
fclose($fp);
//ob_end_flush();
$marshall_islands_main_body = ob_get_clean(); // clean or empty the buffer 
echo $marshall_islands_main_body;
}
?>
