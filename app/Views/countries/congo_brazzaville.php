...
<?php
$cachefile = "../writable/cache/" . "congo_brazzaville_main_body.php" . ".cache";
...
fclose($fp);
//ob_end_flush();
$congo_brazzaville_main_body = ob_get_clean(); // clean or empty the buffer 
echo $congo_brazzaville_main_body;
}
?>
