...
<?php
$cachefile = "../writable/cache/" . "dominican_republic_main_body.php" . ".cache";
...
fclose($fp);
//ob_end_flush();
$dominican_republic_main_body = ob_get_clean(); // clean or empty the buffer 
echo $dominican_republic_main_body;
}
?>
