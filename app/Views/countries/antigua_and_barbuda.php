...
<?php
$cachefile = "../writable/cache/" . "antigua_and_barbuda_main_body.php" . ".cache";
...
fclose($fp);
//ob_end_flush();
$antigua_and_barbuda_main_body = ob_get_clean(); // clean or empty the buffer 
echo $antigua_and_barbuda_main_body;
}
?>
